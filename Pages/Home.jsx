    ...
    <div className="mainback overflow-x-hidden">
      <div className="main">
        <div className="head1">
          <div className="logo">
            <img
              src="https://xtratheme.com/elementor/game/wp-content/uploads/sites/84/2018/09/xtra-logo-game.png"
              alt=""
            />
          </div>
          <div className="logo2">
            <img
              src="https://xtratheme.com/elementor/game/wp-content/uploads/sites/84/2018/04/ads3-1.jpg"
              alt=""
            />
          </div>
        </div>
        ...
        <div className="news0 lg:flex hidden">
          ...
          <Nnews
            image="https://xtratheme.com/elementor/game/wp-content/uploads/sites/84/elementor/thumbs/p8-pfgmvm0ryjympt6apnw1zyucq1az87vwzudgjq50e8.jpg"
          ...
          <Nnews
            image="https://xtratheme.com/elementor/game/wp-content/uploads/sites/84/elementor/thumbs/p16-pfgmv61iqdcr8ftiayzebkvimhhqld4h9na7e0spc0.jpg"
          ...
          <Nnews
            image="https://xtratheme.com/elementor/game/wp-content/uploads/sites/84/elementor/thumbs/p2-pfgmuvpan6yloq8izcii25hg38wp8ozfk83v3z818g.jpg"
        ...
        <div className="section-a">
          <div className="secdiv1">
            ...
            <div className="secdiv1b">
              ...
              >
                <img
                  style={{ scale: zoom ? "1.08" : "" }}
                  src="https://xtratheme.com/elementor/game/wp-content/uploads/sites/84/2018/04/vg2.jpg"
                  alt=""
                />
                <div className="play">
          ...
          <div className="secdiv2">
            <h1>
              MONTHLY GET NEWS AND UPDATES OF XTRA{" "}
              <span className="secdiv2txt0">GAME</span>
            </h1>
            <p>
              The XtraGame site newsletter is the{" "}
              <span className="secdiv2txt">Free</span> and{" "}
              <span className="secdiv2txt">Bursting</span> at the seams with the
              latest games, the cheapest deals and the hottest competitions to
              your inbox <span className="secdiv2txt">Every Week</span>. We
              won't pass your details on and if you don't want to continue to
              receive it you can unsubscribe at any time.
            </p>
        ...
        <div className="discount">
          <div className="disc-txt">
            <h1>
              50% <span>OFF On All PlayStation Addons</span>
            </h1>
            <p>
              Limited time sale, Virtual reality platform new design + Free
              games
            </p>
          ...
          <div className="disc-img">
            <img
              src="https://xtratheme.com/elementor/game/wp-content/uploads/sites/84/2018/04/vr.png"
              alt=""
            />
          </div>
        </div>
        <div className="items-container">
          <Items
            image="https://xtratheme.com/elementor/game/wp-content/uploads/sites/84/2020/02/ps4pro.png"
          ...
          />
          <Items
            image="https://xtratheme.com/elementor/game/wp-content/uploads/sites/84/2018/04/pr3.png"
            txt1="Xbox One"
            txt2="Xbox"
            price="$789"
          />
          <Items
            image="https://xtratheme.com/elementor/game/wp-content/uploads/sites/84/2018/04/pr2.png"
        ...
        <div className="discount2">
          <div className="disc2-txt">
            <h1>
              Playstation <span>5</span> Release Date & News
            </h1>
            <p>
              Limited time sale, Virtual reality platform new design + Free
              games
          ...
          <div className="disc2-img">
            <img
              src="https://xtratheme.com/elementor/game/wp-content/uploads/sites/84/2018/04/ps5_ps5.png"
              alt=""
            />
          </div>
        </div>
        <div className="end">
          <div className="end01">
            <div className="end1">
              ...
              <h1>
                Distinctively enable technically sound data rather than
                bleeding-edge resources assertively my ocardinate.
              </h1>
